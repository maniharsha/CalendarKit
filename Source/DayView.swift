    ...
    public class DayView: UIView {
        ...
        var dayHeaderView:DayHeaderView?
        var timelinePagerView:TimelinePagerView?
        
        var style = CalendarStyle()
        
        static let headerVisibleHeight: CGFloat = 118
        ...
        public init(startDate:Date, endDate:Date, isDefaultScheduleScreen:Bool)
        {
            super.init(frame: .zero)
            self.startDate = startDate
            self.endDate = endDate
            self.dayHeaderView = DayHeaderView(startDate: self.startDate!, endDate: self.endDate!, isDefaultScheduleScreen:isDefaultScheduleScreen)
            self.headerHeight = isDefaultScheduleScreen ? 98 : 118
        ...
        func configure() {
            ...
            dayHeaderView?.quickActionsDelegate = self
    ...
    extension DayView: QuickActionsDelegate
    {
        public func quickActionButtonPressed(forDate: Date) {
            delegate?.quickActionButtonPressed(forDate: forDate)
        }
    }
